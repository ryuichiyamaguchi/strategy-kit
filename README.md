...
| `strategy-kit-v0.12.34.zip` | STRATEGY-KIT 配布版（マーケ戦略立案） |
...
1. お使いの製品の ZIP（`strategy-kit-v0.12.34.zip` / `x-kit-v0.12.24.zip` / `instagram-kit-v0.12.24.zip`）をダウンロードして**解凍**します。
...
現在の配布版: **STRATEGY-KIT v0.12.34** / **X-KIT・INSTAGRAM-KIT v0.12.24**
