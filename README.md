...
| `strategy-kit-v0.12.22.zip` | STRATEGY-KIT 配布版（マーケ戦略立案） |
| `x-kit-v0.12.22.zip` | X-KIT 配布版（X / 旧Twitter アカウント運用） |
| `instagram-kit-v0.12.22.zip` | INSTAGRAM-KIT 配布版（Instagram アカウント運用） |
...
1. お使いの製品の ZIP（`strategy-kit-v0.12.22.zip` / `x-kit-v0.12.22.zip` / `instagram-kit-v0.12.22.zip`）をダウンロードして**解凍**します。
...
- 直リンク: `https://github.com/ryuichiyamaguchi/strategy-kit/raw/main/x-kit-v0.12.22.zip`
- 直リンク: `https://github.com/ryuichiyamaguchi/strategy-kit/raw/main/instagram-kit-v0.12.22.zip`
...
現在の配布版: **v0.12.22**（STRATEGY-KIT / X-KIT / INSTAGRAM-KIT 共通）
